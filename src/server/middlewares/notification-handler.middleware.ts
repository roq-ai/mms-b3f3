...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'delivery_note.create': {
    roles: ['business-owner', 'delivery-manager'],
    key: 'delivery-note-created',
    tenantPath: ['company', 'delivery_note'],
    userPath: [],
  },
  'delivery_note.update': {
    roles: ['business-owner', 'delivery-manager'],
    key: 'delivery-note-updated',
    tenantPath: ['company', 'delivery_note'],
    userPath: [],
  },
  'invalid_note.create': {
    roles: ['business-owner', 'delivery-manager'],
    key: 'delivery-note-invalidated',
    tenantPath: ['company', 'delivery_note', 'invalid_note'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'delivery-manager'];
