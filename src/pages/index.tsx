  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Mms - Streamlining Your Business Deliveries. Manage, track, and optimize your delivery notes with ease. From creation to invalidation, even from Excel tables, we have your delivery operations covered."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1548695607-9c73430ba065?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkZWxpdmVyeXxlbnwwfHx8fDE2OTQwMjI1MDl8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Mms - Streamlining Your Business Deliveries. Manage, track, and optimize your delivery notes with ease. From creation to invalidation, even from Excel tables, we have your delivery operations covered.`}
            </Text>
            <Box
